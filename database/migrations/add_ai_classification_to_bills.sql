-- ============================================================================
-- Migration: Add AI Classification Support to bills table
-- Database: rera8347_constituant
-- Date: 2025-12-08
-- Description: Adds theme, ai_summary, and ai_processed_at columns for
--              Mistral AI integration to the bills table
-- ============================================================================
...
SELECT 'Starting migration: Adding AI classification columns to bills table...' AS Status;
...
SELECT 'Columns added successfully to bills table.' AS Status;
